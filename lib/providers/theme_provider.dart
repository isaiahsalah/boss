...
class ColorPalette {
  ...
  ColorPalette({
    ...
    required this.lightAlternative,
...
class ThemeProvider with ChangeNotifier {
  final ColorPalette _colorPaletteLight = ColorPalette(
    ...
    lightAlternative: const Color(0xFFD4764E),
    background: const Color(0xFF627B8E),
    backgroundAlt: Color.fromARGB(255, 160, 178, 192),
    alternative: Color.fromARGB(255, 192, 87, 42),
  ...
  final ColorPalette _colorPaletteDark = ColorPalette(
    primary: Color.fromARGB(255, 81, 100, 114),
    lightPrimary: const Color(0xFFA7B5BF),
    lightBackground: const Color(0xFF627B8E),
    background: Color.fromARGB(255, 57, 66, 73),
    backgroundAlt: Color.fromARGB(255, 36, 40, 43),
    alternative: Color.fromARGB(255, 211, 109, 50),
    lightAlternative: Color.fromARGB(255, 245, 194, 143),
    white: const Color(0xFFFFFFFF),
    active: const Color(0xFFD4764E),
    red: const Color(0xFFEF927F),
    green: const Color(0xFF9EDBA2),
    ...
    backgroundAlt: const Color(0xff1B2833),
  ...
  bool _isDarkTheme = false; //KevinCrespo
