...
class MyVerticalBarChartWidgetState extends State<MyVerticalBarChartWidget> {
        ...
        children: [
          ...
          Row(
            ...
            children: _dataFuture.contenido!
                .mapIndexed((i, item) => typeChartName(
  ...
  Widget getTitles(
    ...
    return SideTitleWidget(
      ...
      child: RotatedBox(
        quarterTurns: 1,
        child: Text(
            _dataFuture.contenido![0].contenido![value.toInt()].posicion ?? ""),
        /* child: Text(
  ...
  List<BarChartGroupData> getBarGroups({
    ...
    return _dataFuture.contenido![0].contenido!
        .mapIndexed(
          (i, dataFutureContentItem) => BarChartGroupData(
            x: i,
            barRods: _dataFuture.contenido!
                .mapIndexed(
                  (index, dataFutureContent) => BarChartRodData(
                    toY: dataFutureContent.contenido![i].total,
